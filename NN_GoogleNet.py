...
# Define paths
nn_folder = os.path.normpath('NN')  # Folder with class subfolders
features_path = os.path.normpath('trashnet_features_googlenet')  # GoogLeNet features
...
# Iterate through all class subfolders in trashnet_features_googlenet
